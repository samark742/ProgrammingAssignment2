...
## mackeChackeMatrix has four functions setmat, getmat,setmatinverse, getmatinverse. 
##These function are in parent enviromment and are called from cacheSolve function.
